...
object ObjectGenerator {
    ...
    inline fun <reified T> generate(element: Element.ObjectElement, context: GenerationContext): T {
        val meta = ReflectObjectMetaMapper.build(T::class)
        ...
        fieldsLoop@ for (field in meta.fields) {
            ...
            if (provided != null) {
                values[field.fieldName] =
                    convertElement(provided, field.type, context)
                continue
            }
            ...
            generatorLoop@ for (generator in field.generators) {
                try {
                    ...
                    val generated = genInstance.generate(context)
                    if (generated == null) {
