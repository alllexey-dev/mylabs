...
import dev.alllexey.client.command.impl.LoginCommand
import dev.alllexey.client.command.impl.RegisterCommand
...
class ClientApp(
    ...
    var credentials: Request.AuthData? = null
    ...
    init {
        val clientCommands = listOf(
            HelpCommand, ExecuteScriptCommand, ExitCommand, RegisterCommand, LoginCommand
        )
