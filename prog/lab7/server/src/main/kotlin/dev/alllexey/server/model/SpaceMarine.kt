...
data class SpaceMarine(
    ...
    @Ignored
    @Generated(Generator.ProvidedIdGenerator::class, Generator.DummyIdGenerator::class)
    override var id: Long = -1,

    @Ignored
    @Generated(Generator.UserIdGenerator::class)
    ...
    @Ignored
    @Generated(Generator.ProvidedDateTimeGenerator::class, Generator.CurrentDateTimeGenerator::class)
